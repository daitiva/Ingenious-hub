...
export const CLIENTS: Client[] = [
  ...
  { name: "Satya Smriti", category: "Media" },
  ...
  { name: "White Eudicots", category: "B2B" },
  ...
  // Added when verified SVG assets landed (the studio's drop).
  { name: "Prowess Healthcare", category: "Healthcare" },
  { name: "Shree Security Fender", category: "B2B" },
  { name: "Shreenath Group", category: "B2B" },
  { name: "Shubh Vaibhav Decor", category: "D2C" },
  { name: "Summer Hills", category: "Edtech" },
  { name: "SBN Group of Schools", category: "Edtech" },
  { name: "Tagore IPS", category: "Edtech" },
  { name: "Tagore Law College", category: "Edtech" },
  { name: "Volkaline", category: "B2B" },
  { name: "WHMCS Pro", category: "Tech" },
  { name: "Yash Publicity", category: "Media" },
  { name: "YISF", category: "Public" },
  { name: "Yogritu", category: "D2C" },
];
