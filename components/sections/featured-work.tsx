...
const CASES: Case[] = [
  ...
  },
  {
    ...
    slug: "liaison360",
    sector: "B2B · Identity",
    title: "A brand that earns the meeting.",
    problem:
      "A B2B operator winning on relationships and a brand that wasn't yet doing its share in the room. The mark, the deck, the email signature — all under-claiming.",
    thinking:
      "Treat the wordmark like a calling card, not a logo. One identity that survives a contract footer, a partner deck, and a cold email without losing voice.",
    execution: "Wordmark, identity system, document & deck templates, partner-facing collateral.",
    impact: "The brand now opens the first conversation instead of trailing behind it.",
    metrics: [
      { metric: "Identity", label: "system shipped" },
      { metric: "B2B", label: "first-impression brand" },
      { metric: "Live", label: "in sales motion" },
    ],
    eyebrow: "Identity · 2025",
    tone: "teal",
  },
  {
    index: "03",
